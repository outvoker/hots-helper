...
_translations: dict[str, dict[str, str]] = {
    ...
    # === Match records (desktop) =======================================
    "ui.matches.btn": {"zh": "📜 比赛记录", "en": "📜 Match records"},
    "ui.matches.btn_tip": {"zh": "浏览已入库的对局，可按模式/地图/玩家筛选",
                           "en": "Browse ingested matches; filter by mode/map/player"},
    "ui.matches.window_title": {"zh": "比赛记录", "en": "Match records"},
    "ui.matches.mode_sl": {"zh": "风暴联赛", "en": "Storm League"},
    "ui.matches.mode_aram": {"zh": "天命乱斗", "en": "ARAM"},
    "ui.matches.mode_qm": {"zh": "快速匹配", "en": "Quick Match"},
    "ui.matches.mode_all": {"zh": "全部模式", "en": "All modes"},
    "ui.matches.all_maps": {"zh": "全部地图", "en": "All maps"},
    "ui.matches.player_ph": {"zh": "按玩家名筛选…", "en": "Filter by player…"},
    "ui.matches.search": {"zh": "查询", "en": "Search"},
    "ui.matches.summary": {"zh": "共 {total} 场", "en": "{total} matches"},
    "ui.matches.page": {"zh": "第 {page} / {pages} 页", "en": "Page {page} / {pages}"},
    "ui.matches.prev": {"zh": "上一页", "en": "Prev"},
    "ui.matches.next": {"zh": "下一页", "en": "Next"},
    "ui.matches.col_date": {"zh": "时间", "en": "Date"},
    "ui.matches.col_mode": {"zh": "模式", "en": "Mode"},
    "ui.matches.col_map": {"zh": "地图", "en": "Map"},
    "ui.matches.col_dur": {"zh": "时长", "en": "Length"},
    "ui.matches.col_result": {"zh": "结果", "en": "Result"},
    "ui.matches.col_teams": {"zh": "阵容", "en": "Teams"},
    "ui.matches.win": {"zh": "胜", "en": "Win"},
    "ui.matches.loss": {"zh": "负", "en": "Loss"},
    "ui.matches.team_won": {"zh": "队伍 {team} 胜", "en": "Team {team} won"},

    # === Match detail (desktop) ========================================
    "ui.match_detail.window_title": {"zh": "对局详情", "en": "Match detail"},
    "ui.match_detail.not_found": {"zh": "找不到这场对局。", "en": "Match not found."},
    "ui.match_detail.header": {
        "zh": "{map} · {mode} · {dur} · {when}",
        "en": "{map} · {mode} · {dur} · {when}",
    },
    "ui.match_detail.team_won": {"zh": "队伍 {team}（胜）", "en": "Team {team} (win)"},
    "ui.match_detail.team_lost": {"zh": "队伍 {team}（负）", "en": "Team {team} (loss)"},
    "ui.match_detail.col_hero": {"zh": "英雄", "en": "Hero"},
    "ui.match_detail.col_player": {"zh": "玩家", "en": "Player"},
    "ui.match_detail.col_kda": {"zh": "K/D/A", "en": "K/D/A"},
    "ui.match_detail.col_hero_dmg": {"zh": "英雄伤害", "en": "Hero dmg"},
    "ui.match_detail.col_siege": {"zh": "攻城伤害", "en": "Siege dmg"},
    "ui.match_detail.col_healing": {"zh": "治疗", "en": "Healing"},
    "ui.match_detail.col_taken": {"zh": "承受伤害", "en": "Dmg taken"},
    "ui.match_detail.col_xp": {"zh": "经验", "en": "XP"},

    # === Talent build ==================================================
    "ui.talents.btn": {"zh": "🌿 天赋推荐", "en": "🌿 Talent builds"},
    "ui.talents.btn_tip": {"zh": "按胜率查看英雄的天赋加点推荐",
                           "en": "Win-rate talent build per hero"},
    "ui.talents.window_title": {"zh": "天赋加点推荐", "en": "Talent builds"},
    "ui.talents.title_plain": {"zh": "天赋加点推荐（按胜率）",
                               "en": "Talent build (by win-rate)"},
    "ui.talents.hero_label": {"zh": "英雄：", "en": "Hero:"},
    "ui.talents.hero_placeholder": {"zh": "— 选择英雄 —", "en": "— pick a hero —"},
    "ui.talents.pick_hint": {"zh": "先选择一个英雄。", "en": "Pick a hero to start."},
    "ui.talents.dialog_title": {"zh": "{hero} 天赋加点", "en": "{hero} talents"},
    "ui.talents.title": {"zh": "{hero} · 天赋加点推荐（按胜率）",
                          "en": "{hero} · talent build (by win-rate)"},
    "ui.talents.mode_standard": {"zh": "风暴联赛/快速", "en": "SL / QM"},
    "ui.talents.mode_aram": {"zh": "天命乱斗", "en": "ARAM"},
    "ui.talents.summary": {"zh": "{games} 场 · 胜率 {wr}",
                           "en": "{games} games · {wr} win-rate"},
    ...
    "ui.rank.mode_filter": {"zh": "模式", "en": "Mode"},
    "ui.rank.mode_sl": {"zh": "风暴联赛", "en": "Storm League"},
    "ui.rank.mode_aram": {"zh": "天命乱斗", "en": "ARAM"},
